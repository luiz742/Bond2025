          ...
          <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                disabled
              />
              <div v-if="form.errors.to_name" class="text-red-500 text-sm mt-1">{{ form.errors.to_name }}</div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                class="w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-black dark:text-white"
              />
              <div v-if="form.errors.to_address" class="text-red-500 text-sm mt-1">{{ form.errors.to_address }}</div>
            </div>

            <div>
              <label class="block text-sm font-medium mb-1">TRN</label>
              <input
                v-model="form.to_tax_registration_number"
                class="w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-black dark:text-white"
              />
            ...
            <div>
              ...
              <input
                ...
                class="w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-black dark:text-white"
              />
              <div v-if="form.errors.payment_due" class="text-red-500 text-sm mt-1">{{ form.errors.payment_due }}</div>
            </div>

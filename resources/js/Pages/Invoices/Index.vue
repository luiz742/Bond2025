        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-800">
              <tr>
                ...
                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Currency</th>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              <tr v-for="invoice in invoices.data" :key="invoice.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <td class="px-4 py-2 text-sm">
                  ...
                  <Link :href="`/invoices/${invoice.id}/printable`" class="text-green-600 hover:underline">Print</Link>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <div class="mt-4 flex justify-between items-center">
            <button
              ...
              @click="router.visit(invoices.prev_page_url)"
            ...
            <button
              ...
              @click="router.visit(invoices.next_page_url)"
              class="text-sm text-gray-600 dark:text-gray-300"
            >
              Next →
            </button>

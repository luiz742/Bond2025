          ...
          <transition name="fade">
            ...
            >
              <div class="bg-white dark:bg-gray-900 rounded-xl shadow-xl max-w-md w-full p-6 mx-4 relative"
                @click.stop
              >
                <h3 id="modal-title" class="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">
                ...
                <form @submit.prevent="submit" novalidate class="space-y-4">
                  ...
                  <div class="flex justify-end space-x-3">
                    <button type="button" @click="closeModal"
                      class="px-4 py-1.5 rounded-md bg-gray-300 hover:bg-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-800">
              <tr>
                ...
                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Created At</th>

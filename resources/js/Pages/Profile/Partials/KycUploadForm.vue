            ...
            <template v-if="isB2B">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <textarea
                        ...
                        rows="3"
                        class="mt-2 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                    ></textarea>

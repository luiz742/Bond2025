    ...
    <FormSection @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                <InputLabel v-if="props.user.role === 'b2b'"  for="name" value="Company Name" />
            ...
            <!-- Se role for b2b: mostrar Tax Registration Number -->
            ...
            <template v-if="props.user.role === 'b2b' || props.user.role === 'b2c'">
                <!-- Address -->
                <div class="col-span-6 sm:col-span-4">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <TextInput id="contact_number" v-model="form.contact_number" type="text" class="mt-1 block w-full"
                        autocomplete="tel" />
